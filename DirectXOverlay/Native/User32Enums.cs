...
namespace DirectXOverlay.Native
{
    ...
    public enum WindowStyles : uint
    {
        ...
        OverlappedWindow, TiledWindow = Overlapped | Caption | SysMenu | ThickFrame | MinimizeBox | MaximizeBox
    }

    [Flags]
    public enum WindowStylesEx : uint
    {
        Left, LTRReading, RightScrollBar = 0x0,
        DlgModalFrame = 0x1,
        NoParentNotify = 0x4,
        TopMost = 0x8,
        AcceptFiles = 0x10,
